...
namespace Booking.Controllers
{
    ...
    public class PagamentoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CodPagamento,IdtipoPagamento,NomeTitular,NumCartao,DataValidadeCartao,Cvv")] Pagamento pagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("CodPagamento,IdtipoPagamento,NomeTitular,NumCartao,DataValidadeCartao,Cvv")] Pagamento pagamento)
        {
