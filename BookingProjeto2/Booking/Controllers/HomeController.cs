...
namespace Booking.Controllers
{
    public class HomeController : Controller
    {
        ...
        //public ActionResult Index(DateTime entrada, DateTime saida, int adultos, int criancas)
        //{
        //    if (true)
        //    {
        //        @ViewBag.checkin = entrada;
        //        @ViewBag.checkout = saida;
        //        @ViewBag.adultos = adultos;
        //        @ViewBag.criancas = criancas;
        //    }
